	...
	render() {
		...
		return (
			<div className="Registration">
				...
				<form onSubmit={this.onSubmit} className=" col-12 col-md-3">
					<div>
						<div className="fields form-group">
							<p>{ REGISTRATION_FIELDS.FIRST_NAME }</p>
							<input type="text" value={this.state.first_name} className="form-control" name="FirstName" onChange={this.handleOnChangeFirstName}/>
						</div>
						<div className="fields form-group">
								<p>{ REGISTRATION_FIELDS.LAST_NAME }</p>
								<input type="text" value={this.state.last_name} className="form-control" name="LastName" onChange={this.handleOnChangeLastName}/>
						</div>
						<div className="fields form-group">
							<p>{ COMMON_FIELDS.USER_NAME }</p>
							<input type="text" className={classNames({ 'error': user_name_taken , "form-control" : true })} value={this.state.user_name} name="Username" onBlur={this.handleOnBlur} onChange={this.handleOnChangeUserName} autoComplete="Username" required/>
						</div>
						<div className="fields form-group">
							<p>{ COMMON_FIELDS.PASSWORD }</p>
							<input type="password" value={this.state.password} className="form-control" name="Password" onChange={this.handleOnChangePassword} autoComplete="password" required/>
						</div>
