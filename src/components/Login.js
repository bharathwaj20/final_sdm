				...
				<form onSubmit={this.onSubmit} className=" col-12 col-md-3">
					<div>
						<div className="fields form-group">
							...
							<input type="text" name="Username" className="form-control" onChange={this.handleOnChangeUserName} autoComplete="Username" required/>
						</div>
						<div className="fields form-group">
							<p>{ COMMON_FIELDS.PASSWORD }</p>
							<input type="password" name="Password" className="form-control" onChange={this.handleOnChangePassword} autoComplete="Password" required/></div>
